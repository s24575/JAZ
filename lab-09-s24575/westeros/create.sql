create table actor (id bigint generated by default as identity (start with 1), also_known_as varchar(255), biography varchar(65535), birthday date, deathday date, name varchar(255), popularity float(53) not null, profile_path varchar(255), source_id integer not null, primary key (id));
...
create table movie (id bigint generated by default as identity (start with 1), adult boolean not null, backdrop_path varchar(255), budget integer not null, homepage varchar(1023), original_language varchar(255), original_title varchar(255), overview varchar(1023), popularity float(53) not null, poster_path varchar(255), release_date date, runtime integer not null, source_id bigint not null, vote_average float(53) not null, vote_count integer not null, primary key (id));
